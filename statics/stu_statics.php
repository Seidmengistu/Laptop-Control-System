                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a class="d-block btn btn-sm btn-info mr-2" href="../students.php">Students</a></li>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title" style="color:green">Student Statics</h3>
                                </div>
                                <!-- /.card-header -->
