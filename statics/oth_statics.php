                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a class="d-block btn btn-sm btn-info mr-2" href="../others.php">Others</a></li>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title" style="color:green">Others Statics</h3>
                                </div>
                                <!-- /.card-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <form action='../other/othedit.php' method="POST">
                                               <td><button type='submit' class='btn btn-success' name='edit'>Edit</button></td>
                                               <input type='hidden' name='id' value="<?php echo $row['id'];?>">
                                               </form>

                                               <form  action="../other/addothercode.php" method='POST'>
