    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-image:url('statics/images/bg-01.jpg')">
            ...
            <div class="text-center">
                <button type="button" class="btn btn-primary btn-lg ml-5" data-bs-toggle="modal"
                    data-bs-target="#exampleModal">
                    Add Other
                </button>

                <a type="button" href='statics/oth_statics.php' class="btn btn-success btn-lg ml-5">
                    See Statics</a>

                <a type="button" href='check/check_oth.php' class="btn btn-warning btn-lg ml-5">
                    Check Other</a>
            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"
                                style="color:green;font-family:new times roman">Add Other 
                            </h5>
                        ...
                        <div class="modal-body" style="background-image:url('statics/images/bg-01.jpg')">
                            ...
                            <form action='other/addothercode.php' enctype="multipart/form-data" method='POST'>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name='id' id="validationCustom05" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name='mark' id="validationCustom05" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" name='image' idate="image" id="validationCustom05" required>
                                </div>
                        </div>
