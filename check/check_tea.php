  ...
  if(isset($_POST['id'])) {
    ...
    if(mysqli_num_rows($query_run) > 0) {
      $row = mysqli_fetch_assoc($query_run); 
        ...
        $_SESSION['status']="Teacher Not found ";
         ...
         <div class="content-wrapper">
             ...
             <div class="content-header">
                 <div class="container-fluid">
                     <div class="row mb-2">
                         <div class="col-sm-6">
                             <h1 class="m-0 text-dark"style="color:blue">Check Teachers</h1>
                         </div><!-- /.col -->
                         <div class="col-sm-6">
                             <ol class="breadcrumb float-sm-right">
                                 <a class="btn btn-success" href="../teachers.php">Teachers</a>
                             </ol>
                         </div>
                     </div>
                 </div>
                                 ...
                                 <div class="card-body" style="background-image:url('../statics/images/bg-01.jpg')">
                                     ...
                                     <form action='<?=$_SERVER['PHP_SELF']?>' method='POST'>
                                         <div class="mb-3">
                                             ...
                                             <input class="form-control" placeholder="PLease Enter teacher  ID Number Here..." value="<?=isset($row) ? $row['id']:''?>"
                                                 name='id'>
                                         ...
                                         <a href='../statics/tea_statics.php' class='btn btn-danger'>Cancel</a>
