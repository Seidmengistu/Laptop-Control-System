         ...
         <div class="content-wrapper">
             ...
             <div class="content-header">
                 <div class="container-fluid">
                     <div class="row mb-2">
                         <div class="col-sm-6">
                             <h1 class="m-0 text-dark"style="color:blue">Check Others</h1>
                         </div><!-- /.col -->
                         <div class="col-sm-6">
                                 ...
                                 <div class="card-body" style="background-image:url('../statics/images/bg-01.jpg')">
                                     ...
                                     <form action='<?=$_SERVER['PHP_SELF']?>' method='POST'>
                                         <div class="mb-3">
                                             ...
                                             <input class="form-control" placeholder="PLease Enter other  ID Number Here..." value="<?=isset($row) ? $row['id']:''?>"
                                                 name='id'>
                                         ...
                                         <a href='../statics/oth_statics.php' class='btn btn-danger'>Cancel</a>
