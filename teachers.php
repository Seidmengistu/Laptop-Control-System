    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-image:url('statics/images/bg-01.jpg')">
            ...
            <div class="text-center">
                ...
                <a type="button" href='statics/tea_statics.php' class="btn btn-success btn-lg ml-5">
                    See Statics</a>

                <a type="button" href='check/check_tea.php' class="btn btn-warning btn-lg ml-5">
                    Check Teacher</a>
            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"
                                style="color:green;font-family:new times roman">Add Teacher
                            </h5>
                        ...
                        <div class="modal-body" style="background-image:url('statics/images/bg-01.jpg')">
                            ...
                            <form action='teacher/addteachercode.php' enctype="multipart/form-data" method='POST'>
                                <div class="mb-3">
